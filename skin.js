...
// Generated lun set 9 21:03:02 2024
...
function pano2vrSkin(player,base) {
	...
	this.addSkin=function() {
		...
		me._map_1.ondblclick=function (e) {
			if (me._map_1.ggFitBounds) me._map_1.ggFitBounds(true);
		}
	...
	function SkinHotspotClass_ht_image(parentScope,hotspot) {
		...
		el=me._ht_foto_file_image=document.createElement('div');
		els=me._ht_foto_file_image__img=document.createElement('img');
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_foto_file_image__img.setAttribute('src',hs);
		els.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;pointer-events:none;ht_foto_file_image;');
		els['ondragstart']=function() { return false; };
		el.appendChild(els);
		el.ggSubElement = els;
		elo=me._ht_foto_file_image__imgo=document.createElement('img');
		elo.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
		...
		me._ht_foto_file_image__imgo.setAttribute('src',hs);
		elo.setAttribute('style','position: absolute;top: 0px;left: 0px;width: 100%;height: 100%;-webkit-user-drag:none;visibility:hidden;pointer-events:none;ht_foto_file_image;');
		elo['ondragstart']=function() { return false; };
		el.appendChild(elo);
		el.ggId="ht_foto_file_image";
		el.ggDx=0;
		el.ggParameter={ rx:0,ry:0,a:0,sx:1,sy:1 };
		el.ggVisible=true;
		el.className="ggskin ggskin_svg ";
		...
		el.setAttribute('style',hs);
		el.style[domTransform + 'Origin']='50% 50%';
		me._ht_foto_file_image.ggIsActive=function() {
			if ((this.parentNode) && (this.parentNode.ggIsActive)) {
				return this.parentNode.ggIsActive();
			}
			return false;
		...
		me._ht_foto_file_image.onmouseover=function (e) {
			me._ht_foto_file_image__img.style.visibility='hidden';
			me._ht_foto_file_image__imgo.style.visibility='inherit';
		}
		me._ht_foto_file_image.onmouseout=function (e) {
			me._ht_foto_file_image__img.style.visibility='inherit';
			me._ht_foto_file_image__imgo.style.visibility='hidden';
		}
		me._ht_foto_file_image.ggUpdatePosition=function (useTransition) {
			if (useTransition==='undefined') {
				useTransition = false;
			}
			if (!useTransition) {
		...
		me._ht_image.appendChild(me._ht_foto_file_image);
